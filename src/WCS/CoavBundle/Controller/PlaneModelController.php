...
class PlaneModelController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('@WCSCoav/planemodel/index.html.twig', array(
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('@WCSCoav/planemodel/new.html.twig', array(
    ...
    public function showAction(PlaneModel $planeModel)
    {
        ...
        return $this->render('@WCSCoav/planemodel/show.html.twig', array(
            'planeModel' => $planeModel,
    ...
    public function editAction(Request $request, PlaneModel $planeModel)
    {
        ...
        return $this->render('@WCSCoav/planemodel/edit.html.twig', array(
            'planeModel' => $planeModel,
